...
import com.vooom.newsapp.MyApplication


import com.vooom.newsapp.network.Article
import com.vooom.newsapp.network.ArticleSection
import com.vooom.newsapp.network.Section
import com.vooom.newsapp.network.Source
import java.util.*
...
abstract class MyDatabase : RoomDatabase() {
    ...
    companion object {
        var db = Room.databaseBuilder(MyApplication.getInstance(), MyDatabase::class.java, "db").allowMainThreadQueries().build()
    }
